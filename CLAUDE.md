...
- 各 commit における整合性チェック（共通 CLAUDE.md の Git 操作セクション参照）の対象に含めるドキュメントは [docs/Spec.md](docs/Spec.md), [docs/InitialDevelopment.md](docs/InitialDevelopment.md), [README.md](README.md), [docs/Setup.md](docs/Setup.md)
